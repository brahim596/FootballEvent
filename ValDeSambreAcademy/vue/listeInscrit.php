...
<script src="js/listeInscrit.js"></script>
...
<div class="container">
    ...
    <?php
     require_once('../model/inscription.php');
      require_once("../model/gestionInscription.php");
      $conn = new connexionBDD();
      $db = $conn->connexionDB();
      $gestionInscription = new gestionInscription($db);
      $inscriptions=$gestionInscription->getInscriptions();
      $tableau=$gestionInscription->getTabHtml($inscriptions);
      echo($tableau);
     ?>
